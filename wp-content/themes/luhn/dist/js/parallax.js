...
var Parallax = function () {
  ...
  _createClass(Parallax, [{
    ...
    value: function onAnimationFrame() {
      ...
      // TODO: Luhn-code console.log
      for (var index = 0; index < this.layers.length; index++) {

        var layer = this.layers[index],
        depthX = this.clientX - (this.layers[index].offsetLeft+220),
        depthY = this.clientY - (this.layers[index].offsetTop+180);
        
        if(depthY<0){
          var yOffset = -Math.pow(depthY,2 ) / 10000;
        }else{
          var yOffset = Math.pow(depthY,2 ) / 10000;
        }
        if(depthX<0){
          var xOffset =  -Math.pow(depthX,2 ) / 25000;
